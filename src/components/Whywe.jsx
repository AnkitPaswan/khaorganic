            ...
            <div className="whywe">
                <div className="whywe-card">
                    ...
                    <div className="whywe-details">
                        ...
                        <span className="desc">Recyclable packaging is made from materials that can be collected, processed, and made into new products. This helps to conserve natural resources.</span>
                    </div>
                </div>
                <div className="whywe-card">
                    <div className="whywe-thumbnail">
